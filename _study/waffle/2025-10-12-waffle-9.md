...
| :---------------------: | :-------------------------: | :---------------------------------: | :-----------: | :------------: | ------------------------------------------------------------ |
| **i-05ef2fe91990811f4** |     snuboard-server-old     |              snuboard               |       X       |     **O**      | O / O / O 삭제완료!                                          |
| **i-0dd8c3158a21c0c5b** |  snutt-mongodb-production   |                urban                |       X       |     **O**      | O / O / O 삭제완료!                                          |
| **i-013da2db9268167f5** | wafflestudio-nat-instance-a |           nat-instance-a            |       X       |     **X**      | 삭제완료!                                                    |
| **i-0c4b73eb63d3ddb13** |  snutt-mongodb-development  |                urban                |       X       |     **O**      | O / X / O 삭제완료!                                          |
| **i-0f7b0e03b4e793f22** |         waffle-mail         |         wafflestudio (운영)         |       X       |     문의중     | O / (O, X) / O 삭제금지요청!                                 |
| **i-034430587454bf895** |          heywaffle          | wafflestudio<br />(인터널 프로덕트) |       X       |     **O**      | O / X / O 삭제완료!                                          |
| **i-0f8f6c0362c8701d6** |  snutt-mongodb-prod-backup  |                                     |       X       |     **O**      | O / X / O 삭제완료!                                          |
| **i-07f31fd94f69f0999** |          snuboard           |           snuboard-server           |       X       |     **O**      | O / O / O 삭제 완료!                                         |
| **i-08b364059a71ea98d** | wafflestudio-nat-instance-b |                                     |       X       |     **X**      | 삭제완료!                                                    |
...
aws ec2 modify-instance-attribute \
  --instance-id i-05ef2fe91990811f4 \
  --no-disable-api-stop
...
|   vol-0b708bc7ec92d700d   |      | **i-05ef2fe91990811f4** snuboard-server-old       | O                  | O 삭제완료!                |
|   vol-0e8d193325cdaee30   |      | **i-0dd8c3158a21c0c5b** snutt-mongodb-production  | O                  | O 삭제완료!                |
|   vol-02c16d2d24f599be2   |      | **i-0c4b73eb63d3ddb13** snutt-mongodb-development | O                  | O 삭제완료!                |
|   vol-04d9da01d37ea89c5   |      | **i-0f7b0e03b4e793f22** waffle-mail               | O                  | 삭제금지요청!              |
|   vol-0c61b0ceabc2b0431   |      | **i-0f7b0e03b4e793f22** waffle-mail               | O                  | 삭제금지요청!              |
|   vol-0bdf71f0489748074   |      | **i-034430587454bf895** heywaffle                 | O                  | O 존재안함! 누가 삭제한듯! |
|   vol-02b154c0e2261dec2   |      | **i-0f8f6c0362c8701d6** snutt-mongodb-prod-backup | O                  | O 삭제완료!                |
|   vol-0f1ead6ce648926a7   |      | **i-07f31fd94f69f0999** snuboard                  | O                  | O 삭제완료!                |
|       vol-기록못함        |      | **i-013da2db9268167f5** nat-instance-a            |                    | 삭제완료!                  |
|       vol-기록못함        |      | **i-08b364059a71ea98d** nat-instance-b            |                    | 삭제완료!                  |
...
|              ID              |   Team    |                        삭제 가능 여부                        |
| :--------------------------: | :-------: | :----------------------------------------------------------: |
|    **dev/waffle-account**    |  운영팀   |                    문의 중 삭제금지 요청!                    |
|   **local/waffle-account**   |  운영팀   |                    문의 중 삭제금지 요청!                    |
|  **dev/feelin-core-server**  |     ?     |                       ? (냅두면 될듯)                        |
| **dev/feelin-social-server** |     ?     |             올해 다시 접근 있었음! (냅두면 될듯)             |
|       **dev/truffle**        | 트러플 팀 |         문의 중- 변다빈님 알려주신다함 (냅두면 될듯)         |
|       **prod/truffle**       | 트러플 팀 | 문의 중- 변다빈 알려주신다함 올해 다시접근있었음! (냅두면 될듯) |
|     **dev/ggzz-server**      |     ?     |                              ?                               |
...
- ec2, ebs, 시크릿 : waffle-mail 에서 지우지 말아달라는 것 외에 모두 삭제 완료
- ebs : **vol-0f6441f66eccca3c6**, **vol-014474aad5d524f7b** 정체 모를 ec2 2개
- 시크릿 : ggzz 만 지우면 됨.
